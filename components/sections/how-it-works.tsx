      ...
      <div className="max-w-6xl mx-auto">
        <div className="mb-16 flex flex-col lg:flex-row gap-12">
          <div className="lg:w-1/2">
            <p className="text-[#06B6D4] text-2xl sm:text-4xl font-bold pointer-events-none z-10 mb-8">
              what is <span className="text-white">Stellar</span>Proof?
            </p>
            <p className="text-gray-400 text-sm sm:text-lg">
              StellarProof is a reusable kyc layer for stellar ecosystem <br/>
              Users verify once, reuse everywhere. <br/>
            </p>
          </div>
          <div className="lg:w-1/2">
            <p className="text-[#06B6D4] text-2xl sm:text-4xl font-bold pointer-events-none z-10 mb-8">
